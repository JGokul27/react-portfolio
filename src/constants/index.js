...
export const HERO_CONTENT = `I am a Full Developer passionate about creating user-friendly interfaces and robust server-side applications. With hands-on experience in React, Node.js, Express.js and MongoDB, I aim to build scalable web solutions. I thrive on problem-solving and collaboration, ready to tackle real-world challenges in web development.`;
